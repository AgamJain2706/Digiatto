                    ...
                    <div className="grid grid-cols-[50%_auto] md:grid-cols-[30%_auto] lg:grid-cols-[50%_auto] items-center  md:h-16 h-9 sm:h-12">
                        ...
                        <div className="hidden md:block  ">
                            <div className="  flex items-baseline  place-content-evenly ">
                                <NavLink to="/" className="active:text-[#FCB71B] focus:text-[#FCB71B] active:bg-gray-700 focus:bg-gray-700  text-gray-300 hover:bg-gray-700 hover:text-[#FCB71B] px-3 py-4 rounded-md text-sm font-medium ">Home</NavLink>
