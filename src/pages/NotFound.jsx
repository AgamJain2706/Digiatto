...
function NotFound() {
    useEffect(() => {
        // Anime.js animation for .row svg elements
        anime({
            targets: '.row svg',
            translateY: 10,
            autoplay: true,
        ...
        // Anime.js animation for #zero element
        anime({
            targets: '#zero',
            translateX: 10,
            autoplay: true,
        ...
        // alert("The page you are looking for was moved, removed or might never existed.");
    }, []);
    ...
    return (
        <>
            <div className="grid md:grid-cols-[40%_auto] container md:pt-[100px] sm:py-[70px] lg:pb-[100px] 2xl:pt-[145px] lg:pt-[120px] py-[50px] md:px-[30px]  px-[15px]">
                <div className='md:m-auto'>
                    <p className='2xl:text-[90px] xl:text-[50px] sm:text-[40px] text-[30px]'>Error 404</p>
                    <p className='2xl:text-[30px] xl:text-[20px] max-w-[95%] sm:text-[15px] text-[10px]'>The page you are looking for was moved, removed or might never existed.</p>
                    <div className="  xl:pt-[30px] lg:pt-[20px] pt-[10px]   ">
                        <button
                            className=" hover:scale-105 duration-500 btn-grad sm:text-[12px] lg:text-[10px] xl:text-[15px] text-[8px] xl:px-[28px] lg:px-[15px] px-[10px] rounded sm:py-[7px] py-[5px] place-self-center flex justify-center items-center gap-x-1 ">  <FaHome className='inline-block xl:w-5 sm:w-4 w-3 xl:h-5 sm:h-4 h-3 mr-1 -mt-1 group-active:fill-[#FCB71B] group-focus:fill-[#FCB71B] group-hover:fill-[#FCB71B]' />Go To Homepage
                        </button>
                    </div>
                </div>
                <div className="row ">
