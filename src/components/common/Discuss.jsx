...
function Discuss() {
    ...
    const divStyle = {
        boxShadow: '0px 0px 20px rgba(23, 5, 138 , 0.6)' // Black shadow
    };
    // button
    ...
    return (
        <div className="pt-[110px] pb-[40px]">
            <div style={divStyle} className=" mx-auto max-w-[40vw] grid gap-6 sm:gap-1 md:gap-6  w-full  sm:p-[20px] md:p-[25px] p-[15px] xl:p-[40px]  lg:pt-[20px] xl:pt-[30px] bg-[#001034]  ">
                <p className=" text-[19px]">Let&apos;s Discuss</p>
